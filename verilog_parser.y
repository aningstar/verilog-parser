...
function_declaration: /* 1st type function declarations. */
    ...
    OPENPARENTHESES nonempty_function_port_list CLOSEPARENTHESES SEMICOLON
    block_item_declaration_list function_statement ENDFUNCTION { }
|                     FUNCTION AUTOMATIC SIGNED IDENTIFIER OPENPARENTHESES
    nonempty_function_port_list CLOSEPARENTHESES SEMICOLON block_item_declaration_list
...
nonempty_function_port_list: tf_input_declaration { }
|                            nonempty_function_port_list COMMA
    tf_input_declaration { }
|                            nonempty_function_port_list COMMA
    IDENTIFIER { }
;

tf_input_declaration: INPUT REG SIGNED range IDENTIFIER { }
...
function_blocking_assignment: variable_or_bit_select EQUALS_SIGN expression
    SEMICOLON { }
;
...
variable_assignment: variable_lvalue EQUALS_SIGN expression
;
...
param_assignment: IDENTIFIER EQUALS_SIGN constant_expression { }
;
...
|                                  nonempty_list_of_real_identifiers COMMA
    real_type { }
;
