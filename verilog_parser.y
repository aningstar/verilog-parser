...
function_input_declarations:
    ...
    { }
|   function_input_declarations INPUT range_or_type nonempty_identifier_list 
    SEMICOLON 
    { }
;
...
constant_function_call: 
    constant_function_call_with_argument_list CLOSEPARENTHESES 
    { }
;

constant_function_call_with_argument_list: 
    IDENTIFIER OPENPARENTHESES constant_function_argument 
    { }
...
function_call: 
    function_call_with_argument_list CLOSEPARENTHESES 
    { }
;

function_call_with_argument_list: 
    IDENTIFIER OPENPARENTHESES expression 
    { }
|   function_call_with_argument_list COMMA expression 
    { }
;
